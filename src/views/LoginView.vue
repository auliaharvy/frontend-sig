      ...
      <v-layout wrap style="margin-top: 100px;">
        <v-flex sm14 md10 offset-md1>
          <v-card style="height: 466px; border-radius: 20px;" class="login">
            <v-card style="height: 466px; margin-left: 600px;"
                    max-width="400" justify="center" align="center"
            >
            <v-col md="12" align="center" justify="center">
              <v-img src="../assets/logo-sig.png"
                     max-heigth="200"
                     max-width="400"
                     style="margin-top: -40px;"
              ></v-img>
              <v-card-title style="font-size: 15px; margin-top: -20px; margin-left: 25px;"
              >Masuk ke Pallet Management System
              </v-card-title>
              <v-form v-model="valid">
                <v-card-text>
                  <v-text-field :rules="userRules" label="Username" prepend-icon="mdi-account-circle" v-model="user.username" />
                  <v-text-field :rules="pwRules" label="Password" :type="showPassword ? 'text' : 'password'"
...
.body {
  background: url('/src/assets/bg-login.jpeg') no-repeat center center fixed !important;
}
.login {

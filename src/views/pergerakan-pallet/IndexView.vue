  ...
  data() {
    return {
      ...
      headers: [
        ...
        { value: "departure_code", text: this.$t("palletMovement.departure_code"), width: "120px" },
        { value: "departure", text: this.$t("palletMovement.departure"), width: "180px" },
        { value: "destination_code", text: this.$t("palletMovement.destination_code"), width: "120px" },
        { value: "destination", text: this.$t("palletMovement.destination"), width: "180px" },
        { value: "transporter_code", text: this.$t("palletMovement.transporter_code"), width: "120px" },
